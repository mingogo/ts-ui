...
<html lang="en">
  ...
  <body>
    ...
    <div class="jumbotron">
      <div class="container">
        <h1>OOPS.</h1>
        <p> Internal Server error. Note: Mobile device browser may not support the validation script used in this app...enter valid input (7 or 10 digits) to avoid this :)</p>
